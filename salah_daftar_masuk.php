...
<title>SBKA | Salah Daftar Masuk</title>
<!-- InstanceEndEditable -->
...
<div id="kotak2">
  ...
  <div id="body">
   <span id="fontbody2">
      <center>
  Sudahkah anda mendaftar sebagai pelajar ? Jika belum sila DAFTAR SEKARANG atau mungkin NAMA PENGGUNA ATAU KATA LALUAN salah.
  </center>
  </span>
  <form action="check_acc.php" method="POST" id="login">
